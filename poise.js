var poise = (function() {
	...
	var hasOwn = Function.prototype.call.bind(Object.prototype.hasOwnProperty),
		...
		// We use the syntax below (instead of symply PROTO = { }) so that spawns have the name "spawn" when logged.
		PROTO = (function spawn() { }).prototype,
		...
		propsToDescriptors = function propsToDescriptors(props, proto) {
			...
			Object.getOwnPropertyNames(props).forEach(function(name) {
				...
				if (
					// Only Things are magicWrapped to allow a special base method.
					protoIsObject && Thing && isA(proto, Thing)
					&& hasOwn(d, 'value')
		...
		spawn = function spawn(props) {
			// Use poise.PROTO instead of just PROTO below to allow the PROTO proprety to be reassigned.
			return beget(poise && poise.PROTO || PROTO, props);
		},
